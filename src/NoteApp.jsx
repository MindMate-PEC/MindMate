...
//     id: 3,
//     title: "Project Ideas",
//     description: "New app features",
//     image: "https://via.placeholder.com/100",
//   },
//   {
//     id: 4,
//     title: "Travel Plans",
//     description: "Visit Paris, Rome",
//     image: "https://via.placeholder.com/100",
//   },
//   {
//     id: 5,
//     title: "Book Summary",
//     description: "Key takeaways from '1984'",
//     image: "https://via.placeholder.com/100",
//   },
// ];
...
const NoteApp = () => {
    ...
    const fetchNotes = async () => {
      try {
        ...
        const response = await fetch("http://localhost:3000/notes/getNotes", {
          ...
          body: JSON.stringify({ userId }), // Use userId from localStorage
        });

        if (response.ok) {
          const data = await response.json();
          setNotes(data.data); // Assuming the API sends { data: notes }
        } else {
  ...
  console.log("fileterednotes", filteredNotes);
  return (
    <div style={styles.container}>
      {/* Header */}
      <div style={styles.header}>
      ...
      <div style={styles.notesList}>
        {filteredNotes.map((note) => (
          <div key= {note.id} style={styles.card}>
            <div style={styles.cardContent}>
              <h3 style={styles.cardTitle}>{note.heading}</h3>
              <p style={styles.cardDescription}>{note.content}</p>
            </div>
          </div>
        ))}
      </div>
...
// Include the styles object here...
